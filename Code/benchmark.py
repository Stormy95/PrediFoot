...
def test_prediction(tab_training, tab_testing, fonction_prediction, training_size=190):
    ...
    for i in range(training_size, training_size+total_match_count):
        ...
        #print('HomeTeam : {}, AwayTeam : {}, Index i = {}'.format(tab_testing['HomeTeam'][i], tab_testing['AwayTeam'][i], i))
...
def plot_result(training_size=190):
    ...
    random2014 = test_prediction(tab2014[:training_size], tab2014[training_size:], prediction_random, training_size)
    ...
    poisson2014 = test_prediction(tab2014[:training_size], tab2014[training_size:], proba_gagnant, training_size)
