...
def lambda_dom_pondere(tab,equipe_dom,equipe_ext, ponderation=0):
...
def lambda_ext_pondere(tab,equipe_dom,equipe_ext, ponderation=0):
    match_precedent = tab.loc[(tab['HomeTeam']== equipe_ext) & (tab['AwayTeam']==equipe_dom)]
...
def proba_gagnant(tab,equipe_dom,equipe_ext):
    L1=[]
    L2=[]
    lambda1 = lambda_dom_pondere(tab,equipe_dom,equipe_ext, 0)
    lambda2 = lambda_ext_pondere(tab,equipe_dom,equipe_ext, 0)
    for k in range(10):
        #loi de Poisson 
